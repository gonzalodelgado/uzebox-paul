...
// Spectators
#define SPEC_GHOST_LT_X				3
#define SPEC_GHOST_LT_Y				9
#define SPEC_PACMAN_LT_X			3
#define SPEC_PACMAN_LT_Y			12

#define SPEC_GHOST_RT_X				26
#define SPEC_GHOST_RT_Y				8
#define SPEC_PACMAN_RT_X			27
#define SPEC_PACMAN_RT_Y			12
...
bonusFruit fruit;
char p1Score[] PROGMEM = "1UP";
char hs[] PROGMEM = "HIGH SCORE";
char pushStartButton[] PROGMEM = "PUSH START BUTTON";
char onePlayerOnly[] PROGMEM = "1 PLAYER ONLY";
char bonusPacman[] PROGMEM = "BONUS PAC-MAN FOR 10000 PTS";
char copyright[] PROGMEM = "\\ 1980 MIDWAY MFG. CO.";
char creditText[] PROGMEM = "CREDIT     ";
char insertCoin[] PROGMEM = "INSERT COIN";
char charNick[] PROGMEM = "CHARACTER / NICKNAME";
char shadow[] PROGMEM = "-SHADOW";
char speedy[] PROGMEM = "-SPEEDY";
char bashful[] PROGMEM = "-BASHFUL";
char pokey[] PROGMEM = "-POKEY";
char pts[] PROGMEM = "PTS";
char blinkyName[] PROGMEM = "\"BLINKY\"";
char pinkyName[] PROGMEM = "\"PINKY\"";
char inkyName[] PROGMEM = "\"INKY\"";
char clydeName[] PROGMEM = "\"CLYDE\"";
...
void FlashEnergizers(void) {
	static u8 tileIndex = 25, tileIndexIntro = 133;
...
// Makes the images beside the board follow the action with their eyes
void UpdateSpectators(void) {
	if (pacman.loc.y < 10) {
		DrawMap2(SPEC_GHOST_LT_X, SPEC_GHOST_LT_Y, mapGhostLtUp);
		DrawMap2(SPEC_GHOST_RT_X, SPEC_GHOST_RT_Y, mapGhostRtUp);
		DrawMap2(SPEC_PACMAN_LT_X, SPEC_PACMAN_LT_Y, mapPacmanLtUp);
		DrawMap2(SPEC_PACMAN_RT_X, SPEC_PACMAN_RT_Y, mapPacmanRtUp);
	} else if (pacman.loc.y < 14) {
		DrawMap2(SPEC_GHOST_LT_X, SPEC_GHOST_LT_Y, mapGhostLt);
		DrawMap2(SPEC_GHOST_RT_X, SPEC_GHOST_RT_Y, mapGhostRt);
		DrawMap2(SPEC_PACMAN_LT_X, SPEC_PACMAN_LT_Y, mapPacmanLt);
		DrawMap2(SPEC_PACMAN_RT_X, SPEC_PACMAN_RT_Y, mapPacmanRt);
	} else {
		DrawMap2(SPEC_GHOST_LT_X, SPEC_GHOST_LT_Y, mapGhostLtDn);
		DrawMap2(SPEC_GHOST_RT_X, SPEC_GHOST_RT_Y, mapGhostRtDn);
		DrawMap2(SPEC_PACMAN_LT_X, SPEC_PACMAN_LT_Y, mapPacmanLtDn);
		DrawMap2(SPEC_PACMAN_RT_X, SPEC_PACMAN_RT_Y, mapPacmanRtDn);
	}
}
