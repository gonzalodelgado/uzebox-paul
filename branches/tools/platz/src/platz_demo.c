...
#define DEMO_SLICE	(SLICE_COUNT+2)
#define EMPTY_SLICE	(SLICE_COUNT+3)	
...
#define TILE_GRASS_LT					8
#define TILE_GRASS_RT					9
#define TILE_ICICLE						14
#define TILE_ICE						15
#define TILE_TIME_BEST					16
#define TILE_EGG						26
#define TILE_EGG_WATER					27
#define TILE_FONT_START					155
#define TILE_GND_WATER_TOP_LT			105
#define TILE_GND_WATER_TOP_RT			106
#define TILE_GND_BTM_LT					111
#define TILE_GND_BTM_RT					112
