...
- Supports Platz world data files generated by LePlatz v1.1.
...
- Added PLATZ_SLIM define. Saves 1k or more of flash at the cost of minor graphical compromises. Set to 
  zero to disable (enabled by default).
- 1.3k smaller than v1.0 due to collision detection optimizations (2.3k with PLATZ_SLIM=1).
- Added SS_OFFSET_Y define for video mode 2 'Overlay'.
